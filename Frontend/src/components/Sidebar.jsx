...
const Sidebar = () => {
    ...
    //close mobile sidebar onroute change
    useEffect(()=>{
      setMobileOpen(false)
    },[pathname])
    ...
    const sidebarContent = () =>(   
      <>
        ...
        <div className='p-3 border-t border-white/6'>
          <button onClick={handleLogout} className='mt-56 flex items-center gap-3 w-full px-3 py-2.5 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150'>
