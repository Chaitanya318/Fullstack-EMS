        ...
        <div className='space-y-5'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <input disabled value={`${initialData.firstName} ${initialData.position}`} className='bg-slate-50 text-slate-400 cursor-not-allowed'/>
                </div>
            </div>
            <div>
            ...
            {initialData.isDeleted ? (
                ...
                <div className='flex justify-end pt-2'>
                    <button type='submit' disabled={loading} className='btn-primary flex items-center justify-center gap-2 w-full sm:w-auto'>
