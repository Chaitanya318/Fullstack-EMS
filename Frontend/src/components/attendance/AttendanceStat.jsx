import { AlertCircleIcon, Calendar1Icon, Clock12Icon } from 'lucide-react'
...
const AttendanceStat = ({history}) => {
    ...
    const stats = [
      ...
      {label: "Avg. Work Hrs", value: "8.5 Hrs", icon: Clock12Icon},
    ]
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
      {stats.map((s)=>(
        <div key={s.label} className='card card-hover p-5 sm:p-6 flex items-center gap-4 relative overflow-hidden group '>
          <div className='absolute left-0 top-0 bottom-0 w-1 rounded-r-full bg-slate-500/70 group-hover:bg-indigo-500/50' />
