  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      <div className='text-center border-b border-slate-200 pb-6 mb-8'>
        ...
        <p className='text-slate-900 text-sm mt-1'>{format(new Date(paySlip.year, paySlip.month -1), "MMMM yyyy")}</p>
      </div>
        ...
        <table className='w-full text-sm'>
          <thead>
            <tr className='bg-slate-50'>
              <th className='text-left py-3 px-4 text-slate-500 uppercase tracking-wider'>Description</th>
              <th className='text-right py-3 px-4 text-slate-500 uppercase tracking-wider'>Amount</th>
            </tr>
          </thead>
          <tbody>
